...
//    Toast.makeText(this, "service done", Toast.LENGTH_SHORT).show(); 
    ...
    private String trackLocation(Location location) {
        ...
        if (location != null) {
            ...
            result = "Umer: " + Double.toString(longitude) + ", " + Double.toString(latitude);
        }
        return result;
    }
...
//
//
            Intent pushNotification = new Intent(ConfigNotify.PUSH_NOTIFICATION);
            pushNotification.putExtra("latitude", location.getLatitude());
            pushNotification.putExtra("longitude", location.getLongitude());
